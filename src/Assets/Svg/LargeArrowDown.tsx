...
function LargeArrowDown(props: React.SVGProps<SVGSVGElement>) {
	return (
		<svg width={25} height={25} fill="none" {...props}>
			<path
				transform="rotate(-90 0 25)"
				fill="url(#prefix__pattern1000)"
				fillOpacity={0.3}
				d="M0 25h25v25H0z"
			/>
			<defs>
				<pattern
					id="prefix__pattern1000"
					patternContentUnits="objectBoundingBox"
					width={1}
					height={1}
				>
					<use
						xlinkHref="#prefix__image1000_7_5757"
						transform="scale(.00195)"
					/>
				</pattern>
				<image
					id="prefix__image1000_7_5757"
					width={512}
					height={512}
...
const MemoLargeArrowDown = React.memo(LargeArrowDown);
export default MemoLargeArrowDown;
