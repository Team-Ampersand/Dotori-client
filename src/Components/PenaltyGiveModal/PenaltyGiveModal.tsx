					...
					<S.PenaltyGiveContainer>
						...
						<S.List>
							...
							>
								...
								<option value="VIOLATION_OF_THE_USE_OF_FACILITIES">
									공공시설물 사용규정 위반
								</option>
								<option value="DAMAGE_OF_POST">부착된 게시물 훼손</option>
								<option value="POSSESSION_OF_ELECTRONICS_DEVICES">
									전자기기 소지 혹은 사용
								</option>
								<option value="CLEAN_COUNDITION_BAD">
									호실 정리정돈 상태 불량
								</option>
								...
								<option value="ENTRY_TO_PROHIBITED_AREAS">
									출입 금지 구역 출입
								</option>
								<option value="VIOLATION_OF_STUDY_ROOM_RULES">
									학습실 면학분위기 저해
								</option>
