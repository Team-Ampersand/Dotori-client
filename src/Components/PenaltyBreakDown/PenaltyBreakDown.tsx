  ...
  const ViolationHistoryList = [penaltyList] && [penaltyList].map((item) => { 
    ...
    const SmallCatergories = obj.map((item:any) => {
      ...
      return(
        ...
        {ban ? item[0] === "FIREARMS" || item[0] === "WEAPON" || item[0] === "ALCOHOL" || item[0] === "TOBACCO" || item[0] === "MEANDERING_APPARATUS" || item[0] === "FOOD" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {unfulfill ? item[0] === "MANAGER_GUIDANCE" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {time ? item[0] === "TIME" || item[0] === "OUTING" || item[0] === "OVERNIGHT_STAY" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {damage ? item[0] === "DAMAGE_OF_GOODS" || item[0] === "THEFT" || item[0] === "CHANTAGE" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {sleep ? item[0] === "DISTURBING_SLEEP" || item[0] === "ELECTRONIC_DEVICE" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {hygiene ? item[0] === "LOUD" || item[0] === "INCOREECT_ENTRY" || item[0] === "LAUNDRY" || item[0] === "VIOLATION_OF_THE_USE_OF_FACILITIES" || item[0] === "DAMAGE_OF_POST" || item[0] === "POSSESSION_OF_ELECTRONICS_DEVICES" || item[0] === "CLEAN_COUNDITION_BAD" || item[0] === "ENVIRONMENT_POLLUTION" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {affection ? item[0] === "AFFECTIONATE_ACT" || item[0] === "SEXUAL_ACT" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {entry ? item[0] === "ENTRY_TO_PROHIBITED_AREAS" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {learn ? item[0] === "VIOLATION_OF_STUDY_ROOM_RULES" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        {outside ? item[0] === "OUTSIDER_ENTRY" ? <S.SmallCategories><S.NameWrapper>{returnPenaltyValue(item[0])}</S.NameWrapper><S.CntWrapper>{item[1].cnt}회</S.CntWrapper><S.DateWrapper onClick={handleMoreBtn} className={closed ? "" : "close"}>{item[1].date.sort().join("\n")}</S.DateWrapper></S.SmallCategories> : null : null}
        </>
      )
    })
